...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-slate-950 text-white lg:min-h-[760px]">
      ...
      />
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(2,6,23,0.96)_0%,rgba(2,6,23,0.86)_46%,rgba(2,6,23,0.34)_82%,rgba(2,6,23,0.54)_100%)]" />
      <div className="absolute inset-x-0 bottom-0 h-44 bg-gradient-to-t from-slate-950 via-slate-950/65 to-transparent" />
      ...
      <div className="section-shell relative py-10 min-[380px]:py-12 sm:py-20 lg:py-24">
        <div className="grid gap-12 lg:grid-cols-[1fr_0.72fr] lg:items-center">
          <div className="max-w-3xl">
            ...
            <div className="mobile-scroll mt-5 flex flex-nowrap gap-4 overflow-x-auto pb-1 text-xs font-semibold text-slate-200 sm:mt-6 sm:flex-wrap sm:gap-x-5 sm:gap-y-2 sm:overflow-visible sm:text-sm">
              {["Free technical previews", "Plot and size checks", "Editable CAD, Revit and IFC"].map((item) => (
          ...
          <div className="hidden w-full max-w-md justify-self-end lg:block">
            <div className="relative rounded-lg border border-white/15 bg-white/[0.08] p-3 shadow-[0_24px_70px_rgba(0,0,0,0.36)] backdrop-blur-xl">
              ...
              <div className="p-3 pb-2 pt-5">
                <p className="text-xs font-bold uppercase tracking-[0.14em] text-sky-300">MFHP-001 / 2026</p>
                <h2 className="mt-2 text-2xl font-extrabold">Modern 3 Bedroom House</h2>
                ...
                <div className="mt-4 grid grid-cols-3 gap-2 text-center">
                  {[["168 m2", "Area"], ["3 beds", "Program"], ["20x20 m", "Plot"]].map(([value, label]) => (
        ...
        <div className="mt-8 grid overflow-hidden rounded-lg border border-white/15 bg-white/10 shadow-[0_18px_50px_rgba(0,0,0,0.24)] backdrop-blur-xl sm:mt-12 sm:grid-cols-3 lg:mt-20">
